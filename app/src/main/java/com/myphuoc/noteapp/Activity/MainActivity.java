...
public class MainActivity extends AppCompatActivity implements NoteListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        // resultCode được set bởi CreateNoteActivity
            ...
            if (data != null) {
                ...
                if (takePhotoUri != null) {
                    try {
                        ...
                        // Tạo một Intent để start CreateNoteActivity
                        Intent intent = new Intent(getApplicationContext(), CreateNoteActivity.class);
                        intent.putExtra("isFromQuickActions", true);
                        intent.putExtra("quickActionType", "image");
                        intent.putExtra("imagePath", selectedImagePath);

                        // Start CreateNoteActivity với request code vừa được khai báo trước đó
                        startActivityForResult(intent, REQUEST_CODE_ADD_NOTE);
                        inputSearch.setText(null);
